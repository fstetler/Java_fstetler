...
public class CourseRetrievalService {
    ...
    public List<PluralsightCourse> getCourseFor(String authorId) {
        HttpRequest request =
                HttpRequest.newBuilder(URI.create(PS_URI.formatted(authorId)))
                .GET()
                .build();
        ...
        try {
            ...
            return switch(response.statusCode()) {
                case 200 -> toPlugalsightCourses(response);
                case 404 -> List.of();
                default -> throw new RuntimeException("Plusalsight API call failed with status code " + response.statusCode() );
            };
    ...
    private static List<PluralsightCourse> toPlugalsightCourses(HttpResponse<String> response) throws JsonProcessingException {
